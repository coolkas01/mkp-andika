...
extension CartQueryFilter on QueryBuilder<Cart, Cart, QFilterCondition> {
  ...
  QueryBuilder<Cart, Cart, QAfterFilterCondition> productIdEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Cart, Cart, QAfterFilterCondition> userIdEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'userId',
        value: value,
  ...
  QueryBuilder<Cart, Cart, QAfterFilterCondition> userIdGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Cart, Cart, QAfterFilterCondition> userIdLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Cart, Cart, QAfterFilterCondition> userIdBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension CartQuerySortBy on QueryBuilder<Cart, Cart, QSortBy> {
  QueryBuilder<Cart, Cart, QAfterSortBy> sortByProductId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'productId', Sort.asc);
    });
  }

  QueryBuilder<Cart, Cart, QAfterSortBy> sortByProductIdDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Cart, Cart, QAfterSortBy> sortByUserId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userId', Sort.asc);
    });
  }

  QueryBuilder<Cart, Cart, QAfterSortBy> sortByUserIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CartQuerySortThenBy on QueryBuilder<Cart, Cart, QSortThenBy> {
  ...
  QueryBuilder<Cart, Cart, QAfterSortBy> thenByProductId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'productId', Sort.asc);
    });
  }

  QueryBuilder<Cart, Cart, QAfterSortBy> thenByProductIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'productId', Sort.desc);
    });
  }
  ...
  QueryBuilder<Cart, Cart, QAfterSortBy> thenByUserId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userId', Sort.asc);
    });
  }

  QueryBuilder<Cart, Cart, QAfterSortBy> thenByUserIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userId', Sort.desc);
    });
  }
...
extension CartQueryWhereDistinct on QueryBuilder<Cart, Cart, QDistinct> {
  QueryBuilder<Cart, Cart, QDistinct> distinctByProductId() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Cart, Cart, QDistinct> distinctByUserId() {
    return QueryBuilder.apply(this, (query) {
...
extension CartQueryProperty on QueryBuilder<Cart, Cart, QQueryProperty> {
  ...
  QueryBuilder<Cart, int, QQueryOperations> productIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Cart, int, QQueryOperations> userIdProperty() {
    return QueryBuilder.apply(this, (query) {
